/* autogenerated by Processing revision 1292 on 2023-08-07 */
...
public void draw() {
  ...
  if(lyrics != null){
    if(lyrics.length-line > 30){
      lyrScroll += PApplet.parseInt(scroll);
...
public void selector(){
  ...
  scrollPos += PApplet.parseInt(scroll);
  scroll = 0;
  if(fc){
...
public class MusicFile{
  ...
  public void fileDisplay(float yChange){
    textSize(textScale);
    y -= PApplet.parseInt(yChange) * (textScale+18);
    float tooLong = textWidth(name);
    int notYet = colVars[5];
    int notYetStroke = colVars[2];
...
public class Options{
  ...
  public void button(Boolean mouseReleased){
    ...
    if(boo){
      ...
      openMenu = "v";
      yShift = 4;
      xShift = PApplet.parseInt(width-textWidth(openMenu)-7);
    } else {
      menuOpen = false;
      fill(colVars[5]);
      stroke(colVars[2]);
    ...
    textFont(font);
    editorOpen("T", PApplet.parseInt(width-textWidth("T")-5)-6, height-buttonScale-80, 0, mouseReleased);
    font = createFont("Dialog.plain", 5);
    textFont(font);
    reloadButton(PApplet.parseInt(width-15), height-buttonScale-115, 0, mouseReleased);
  }
  ...
  public Boolean allNotMenuButtons(String name, int x, int y, int yShift, Boolean mouseReleased, Boolean tester){
  ...
  public void editorOpen(String name, int x, int y, int yShift, Boolean mouseReleased){
  ...
  public void reloadButton(int x, int y, int yShift, Boolean mouseReleased){
    float iconScale = 11.5f;
    float xOffset = x - 6;
    float yOffset = y + 22;
    //Updating lyrics...
    ...
    xOffset -=6;
    yOffset -=7;
    triangle(iconScale * (75 + 12.5f) + xOffset, iconScale * (25 - 12.5f) + yOffset, 
             iconScale * (75 - 18) + xOffset, iconScale * (75 - 12.5f) + yOffset, 
             iconScale * (100 + 18) + xOffset, iconScale * (75 - 12.5f) + yOffset);
  }
